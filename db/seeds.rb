...
track05 = Track.create!(name: "Music", artist: "One way", duration: "4min30s", category: category01, year: "1978", audio_url: "https://res.cloudinary.com/dytbi4y5w/video/upload/v1496777387/Funky_Collector_03_-_01_-_One_Way_ft_Al_Hudson_-_Music_l6tc3e.mp3", artist_description: "No description")
track06 = Track.create!(name: "Gonna be the one", artist: "Colors", duration: "4min30s", category: category01, year: "1983", audio_url: "https://res.cloudinary.com/dytbi4y5w/video/upload/v1496777018/Colors_-_Am_I_Gonna_Be_The_One__83__US_12_Inch_lmrnvd.mp3", artist_description: "No description")
